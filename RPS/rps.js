...
function win(Player1, Player2) {
    ...
    selfTimeout(() => Player1Choice_div.classlist.remove("green-glow"), 500);
}
...
function lose(Player1, Player2) {
    ...
    p1score_span.innerHTML = p1score;
    p2score_span.innerHTML = p2score;
    result_div.innerHTML = `${convertToWord(Player1)} beats ${convertToWord(Player2)} . You lose!`;
    Player1Choice_div.classlist.add("red-glow");
    selfTimeout(() => Player1Choice_div.classlist.remove("red-glow"), 500);
}
...
function draw(Player1, Player2) {
    ...
    p1score_span.innerHTML = p1score;
    p2score_span.innerHTML = p2score;
    result_div.innerHTML = `${convertToWord(Player1)}  equals  ${convertToWord(Player2)} ......... It's a draw!`;
    Player1Choice_div.classlist.add("draw-glow");
    selfTimeout(() => Player1Choice_div.classlist.remove("draw-glow"), 500);
}
